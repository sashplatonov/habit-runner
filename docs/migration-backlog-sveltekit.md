...
#### Подзадачи
- [ ] Перенести карусель → Svelte с `$state` для индекса
- [ ] Перенести slide transitions
- [ ] Сравнить анимации
...
#### Подзадачи
- [ ] Создать `+page.svelte` для каждого intent
- [ ] Перенести JSON-LD → `<svelte:head>`
- [ ] Перенести meta tags → `<svelte:head>`
- [ ] Проверить SEO output (meta, JSON-LD)
...
#### Подзадачи
- [ ] Перенести → Svelte
- [ ] Заменить clsx → Svelte class directives
- [ ] lucide-react → lucide-svelte

#### Acceptance Criteria
- Tooltip визуально идентичен
...
#### Подзадачи
- [ ] Перенести → Svelte
- [ ] Перенести push subscription flow
- [ ] Сравнить визуал
...
#### Подзадачи
- [ ] Создать Svelte action
- [ ] Перенести touch event handling
