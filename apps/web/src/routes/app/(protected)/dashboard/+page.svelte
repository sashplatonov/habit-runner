              ...
              {#if menuOpen}
                ...
                >
                  <div class="px-3 pt-3 pb-1">
                    <div class="text-xs font-mono uppercase tracking-widest text-muted">Actions</div>

                    <div class="mt-3 space-y-1">
                      <div class="rounded-md px-3 py-2 text-left text-sm text-muted">
                        Data updates are saved directly to the server.
                      </div>
                    </div>
                  </div>
