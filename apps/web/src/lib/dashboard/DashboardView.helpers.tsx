...
import type { ViewDensity } from '@/pages/components/DashboardHero';
import { HabitRowToggleButton } from '@/pages/components/DashboardHabitTile';
export { HabitTile } from '@/pages/components/DashboardHabitTile';
...
export function HabitRowCardContent({
  habit,
  accent,
  innerPaddingClass,
  gripHandleClass,
