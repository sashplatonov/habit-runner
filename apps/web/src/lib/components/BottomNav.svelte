...
<nav
  class="fixed bottom-0 left-0 right-0 z-50 flex border-t border-border bg-bg-secondary/88 shadow-[0_-18px_40px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:hidden"
